...
export class AccountApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public createContact(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
   ...
   * </em>
   */
  public updateContact(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/contact";
    let _routeParams: any = {
   ...
   * This method returns no data.
   */
  public destroyContact(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/contact";
    let _routeParams: any = {
   ...
   * </em>
   */
  public verifyEmail(data: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * </em>
   */
  public resendVerification(data: any, req: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * </em>
   */
  public resetPasswordRequest(credentials: any, req: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * </em>
   */
  public resetAccountPassword(data: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/reset-account-password";
    let _routeParams: any = {};
    let _postBody: any = {
      data: data
    };
   ...
   * </em>
   */
  public socialLogin(data: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * </em>
   */
  public sendUserEmail(data: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/send-user-email/";
    let _routeParams: any = {};
    let _postBody: any = {
      data: data
    };
  ...
  /**
   * sends email to list of emails that arent users
   *
   * @param {object} data Request data.
   *
   * This method expects a subset of model properties as request parameters.
   ...
   * </em>
   */
  public sendEmail(data: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/send-email/";
    let _routeParams: any = {};
   ...
   * </em>
   */
  public setInvitationCode(data: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/set-invitation-code";
    let _routeParams: any = {};
    let _postBody: any = {
      data: data
    };
   ...
   * </em>
   */
  public createManyContact(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/contact";
    let _routeParams: any = {
